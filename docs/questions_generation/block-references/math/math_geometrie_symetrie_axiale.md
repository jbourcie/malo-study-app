...
- Thème (theme): Géométrie
- Ordre (order): 340

## Compétence
(À compléter) Objectif de la notion « Symétrie axiale ».

## Définition {#definition}
(À compléter) Définition courte, niveau 5e, pour « Symétrie axiale ».

## Méthode {#methode}
(À compléter) Étapes/règles à appliquer pour réussir sur « Symétrie axiale ».
