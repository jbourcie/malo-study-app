...
- Matière (subject): math
- Thème (theme): Fractions
- Ordre (order): 90

## Compétence
(À compléter) Objectif de la notion « Multiplication de fractions ».

## Définition {#definition}
(À compléter) Définition courte, niveau 5e, pour « Multiplication de fractions ».

## Méthode {#methode}
(À compléter) Étapes/règles à appliquer pour réussir sur « Multiplication de fractions ».
