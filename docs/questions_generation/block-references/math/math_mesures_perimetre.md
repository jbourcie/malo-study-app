...
- Thème (theme): Grandeurs & mesures
- Ordre (order): 410

## Compétence
(À compléter) Objectif de la notion « Périmètre ».

## Définition {#definition}
(À compléter) Définition courte, niveau 5e, pour « Périmètre ».

## Méthode {#methode}
(À compléter) Étapes/règles à appliquer pour réussir sur « Périmètre ».
