...
## Compétence
(À compléter) Objectif de la notion « Triangles ».

## Définition {#definition}
(À compléter) Définition courte, niveau 5e, pour « Triangles ».

## Méthode {#methode}
(À compléter) Étapes/règles à appliquer pour réussir sur « Triangles ».
