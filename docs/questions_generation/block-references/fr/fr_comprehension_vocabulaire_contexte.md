...
## Compétence
Comprendre un mot grâce au contexte.

## Définition {#definition}
(À compléter) Définition courte, niveau 5e, pour « Vocabulaire en contexte ».

## Méthode {#methode}
(À compléter) Étapes/règles à appliquer pour réussir sur « Vocabulaire en contexte ».
