...
- Label: Futur simple
- Matière (subject): fr
- Thème (theme): Conjugaison
- Ordre (order): 440

## Compétence
(À compléter) Objectif de la notion « Futur simple ».

## Définition {#definition}
(À compléter) Définition courte, niveau 5e, pour « Futur simple ».

## Méthode {#methode}
(À compléter) Étapes/règles à appliquer pour réussir sur « Futur simple ».
