...
- Label: Passé (bases)
- Matière (subject): es
- Thème (theme): Grammaire
- Ordre (order): 130

## Compétence
(À compléter) Objectif de la notion « Passé (bases) ».

## Définition {#definition}
(À compléter) Définition courte, niveau 5e, pour « Passé (bases) ».

## Méthode {#methode}
(À compléter) Étapes/règles à appliquer pour réussir sur « Passé (bases) ».
